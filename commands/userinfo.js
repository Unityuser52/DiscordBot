...
module.exports.run = async (bot, message, args) => {
    ...
    const background = await Canvas.loadImage("https://wallpapercave.com/wp/wp6823313.jpg");
    ...
    botEvents.send(`userinfo.js command executed succesfully in ${message.guild.name} by ${message.author.toString()}!`);
